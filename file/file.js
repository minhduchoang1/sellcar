...
function Loaded()
{
	...
	imgp.style.backgroundImage = "url('https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/O-Jolle_red.svg/540px-O-Jolle_red.svg.png')";
...
function Click(id)
{
	...
	var path = "url('https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/O-Jolle_red.svg/540px-O-Jolle_red.svg.png')";
	if (CPlayer == 1) path = "url('https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Red_X.svg/768px-Red_X.svg.png')";
	...
	if (!AI)
	{
		...
		var iplayer = "url('https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/O-Jolle_red.svg/540px-O-Jolle_red.svg.png')";
		if (CPlayer == 1) iplayer = "url('https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Red_X.svg/768px-Red_X.svg.png')";
		var imgp = document.getElementById("imgPlayer");
